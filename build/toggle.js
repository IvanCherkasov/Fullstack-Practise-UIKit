...
const toggle1 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Toggle($('#uikit-toggle-id-1'));
const toggle2 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Toggle($('#uikit-toggle-id-2'));
const toggle3 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Toggle($('#uikit-toggle-id-3'));
const toggle4 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Toggle($('#uikit-toggle-id-4'));
