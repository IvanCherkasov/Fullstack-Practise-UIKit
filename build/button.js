...
const btnKit = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Button($('#uikit-button-id'));
const btnKit2 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Button($('#uikit-button-id-2'));
const btnKit3 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Button($('#uikit-button-id-3'));
const btnKit4 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Button($('#uikit-button-id-4'));
