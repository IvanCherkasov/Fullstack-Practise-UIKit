...
const progressBar1 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].RadialProgress($('#uikit-radial-progress-id-1'));
const progressBar2 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].RadialProgress($('#uikit-radial-progress-id-2'));
const progressBar3 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].RadialProgress($('#uikit-radial-progress-id-3'));
