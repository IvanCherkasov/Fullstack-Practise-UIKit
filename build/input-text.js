...
const formElems = [];
formElems.push(new __WEBPACK_IMPORTED_MODULE_0__index__["default"].InputText($('#form-ui-input-name-id')));
formElems.push(new __WEBPACK_IMPORTED_MODULE_0__index__["default"].InputText($('#form-ui-input-email-id')));
formElems.push(new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Textarea($('#form-ui-textarea-id')));
formElems.push(new __WEBPACK_IMPORTED_MODULE_0__index__["default"].Button($('#form-ui-btn-id')));
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(1)))
