...
const arrowButton1 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].ArrowButton($('#uikit-arrow-button-id-1'));
const arrowButton4 = new __WEBPACK_IMPORTED_MODULE_0__index__["default"].ArrowButton($('#uikit-arrow-button-id-4'));
